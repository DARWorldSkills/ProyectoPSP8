 ...
 */
public class FragmentDefectPlanSumm extends Fragment {

    RecyclerView recyclerView;

    public FragmentDefectPlanSumm() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fragment_defect_plan_summ, container, false);
